...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.me.ThrowPoker,com.me.PokerGrade,com.me.AddGrade,com.me.Initial"%>
...
<jsp:useBean id="throwP" class="com.me.Initial"></jsp:useBean>
...
out.println("玩家手牌：");
 //  out.println(throwP.player1.get(0).colour+ throwP.player1.get(0).Num+
//		   throwP.player1.get(1).colour+throwP.player1.get(1).Num+
//	     throwP.player1.get(2).colour+throwP.player1.get(2).Num);
%>
...
<%
out.println("电脑手牌：");
//out.println(throwP.auto.get(0).colour+ throwP.auto.get(0).Num+
//		throwP.auto.get(1).colour+throwP.auto.get(1).Num+
//		throwP.auto.get(2).colour+throwP.auto.get(2).Num);
%>
...
Grade=(AddGrade)session.getAttribute("grade3");
compare.compare(throwP.player1, throwP.auto);//比较手牌大小It.auto为弃前五张牌。auto为弃后三张牌
...
if(b == 1||b == -1)
	response.sendRedirect("end2.jsp");
...
<a href="end2.jsp"><img alt="" src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1509178025406&di=9bd4a871306c1e9cbb28f1a36c4bd682&imgtype=0&src=http%3A%2F%2Fimgsrc.baidu.com%2Fimgad%2Fpic%2Fitem%2Ff703738da97739123ca4de5af3198618367ae20f.jpg"
width = "30" height = "30"></a>
</body>
</html>